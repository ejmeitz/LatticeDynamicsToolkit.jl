...
function fit_ifc2(
    ...
    @info "Fitting AmorphousIFC2" n_atoms=na n_pairs=n_pairs n_samples=n_samples n_unknowns=n_unknowns n_equations=n_equations
    ...
    @info "Fit complete" rmse_Hartree_bohr=rmse max_error_Hartree_bohr=max_err
